    ...
    options: [
      {
        ...
        available: true,
        values: [
          { id: poulet, optionId: viande, name: "Poulet", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
          { id: kefta, optionId: viande, name: "Kefta", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
          { id: mixte, optionId: viande, name: "Mixte", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
        ],
      },
      {
        id: sauces,
        ...
        available: true,
        values: [
          { id: algerienne, optionId: sauces, name: "Algerienne", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
          { id: samourai, optionId: sauces, name: "Samourai", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
          { id: harissa, optionId: sauces, name: "Harissa", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
          { id: blanche, optionId: sauces, name: "Blanche", priceAddition: "0.00", available: true, allowQuantity: false, maxQuantity: null },
        ],
      },
      {
        id: supplements,
        ...
        available: true,
        values: [
          { id: cheddar, optionId: supplements, name: "Cheddar", priceAddition: "6.00", available: true, allowQuantity: false, maxQuantity: null },
        ],
      },
    ],
  };
  ...
  const result = validateConfiguredLine(
    {
      ...
      selected_option_values: [
        { id: kefta, quantity: 1 },
        { id: mixte, quantity: 1 },
        { id: algerienne, quantity: 1 },
        { id: samourai, quantity: 1 },
        { id: harissa, quantity: 1 },
        { id: blanche, quantity: 1 },
      ],
      unit_price: 55,
    },
    snackAtlasTacos(),
  ...
  const result = validateConfiguredLine(
    {
      ...
      selected_option_values: [{ id: kefta, quantity: 1 }],
      unit_price: 55,
    },
    snackAtlasTacos(),
  );
